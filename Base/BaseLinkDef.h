...
#pragma link C++ class TwoPartDiffCorrelationAnalyzer < AnalysisConfiguration::kRapidity> + ;
#pragma link C++ class TwoPartDiffCorrelationAnalyzer < AnalysisConfiguration::kPseudorapidity> + ;
#pragma link C++ class TwoPartDiffCorrelationAnalyzerME < AnalysisConfiguration::kRapidity> + ;
#pragma link C++ class TwoPartDiffCorrelationAnalyzerME < AnalysisConfiguration::kPseudorapidity> + ;
